  ...
  return (
    <div className="flex justify-center sm:justify-start mx-10 my-10 text-white gap-8 text-xl">
      ...
      <div
        ...
        className={`flex flex-col items-center cursor-pointer ${marketNavSelected === "apps" && "border-b-2 border-blue-500"
          }`}
      >
      ...
      <div
        ...
        className={`flex flex-col items-center cursor-pointer ${marketNavSelected === "news" && "border-b-2 border-blue-500"
          }`}
      >
